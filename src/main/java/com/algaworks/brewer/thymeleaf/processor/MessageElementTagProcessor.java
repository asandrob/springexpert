...
public class MessageElementTagProcessor extends AbstractElementTagProcessor {
	...
	protected void doProcess(ITemplateContext context, IProcessableElementTag tag,
		...
		model.add(modelFactory.createStandaloneElementTag("th:block","th:include","~{fragmentos/MensagemSucesso :: mensagemSucesso}"));
		model.add(modelFactory.createStandaloneElementTag("th:block","th:include","~{fragmentos/MensagensErroValidacao :: mensagemErro}"));
